...
def create_azure_ai900():
    dest_dir = r'exams\azure\ai-900'
...
<head>
    ...
    <title>Azure AI-900 - Revision Guide</title>
    <link rel="stylesheet" href="../../assets/style.css">
</head>
<body>
    <div class="container">
        <a href="../../index.html" class="btn">← Back to Dashboard</a>
        <h1>Azure AI Fundamentals (AI-900)</h1>
        <h2>Revision Guide</h2>
        <div style="background:#222; padding: 10px; margin-bottom: 20px; border: 1px solid #0078d4; color: #0078d4;">
            LAST-MINUTE CRAM: Content to be generated. Focus on Computer Vision, NLP, Conversational AI, Document Intelligence, and Responsible AI principles.
        </div>
    </div>
</body>
</html>"""
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Azure AI-900 - Set {set_idx+1}</title>
    <link rel="stylesheet" href="../../assets/style.css">
</head>
<body data-exam-id="azure-ai-set{set_idx+1}">
    <div class="container">
        <a href="../../index.html" class="btn">← Back to Dashboard</a>
...
"""
        for i in range(20):
            set_html += f"""
        <div class="q-block">
            <div class="q-line">Q{i+1}. [Azure AI-900 Placeholder Question]</div>
...
<head>
    ...
    <title>Azure AI-900 - Flashcards</title>
    <link rel="stylesheet" href="../../assets/style.css">
</head>
<body>
    <div class="container">
    ...
    <script>
        const cards = [
            { f: '[AI-900 Term Placeholder]', b: '[AI-900 Definition Placeholder]' },
        ];
    ...
    print(f"Successfully generated placeholder files for exams\\azure\\ai-900")
